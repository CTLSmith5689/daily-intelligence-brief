...
:root[data-theme="light"] {
  --bg-base:#F4F1EA; --bg-1:#FFFFFF; --bg-2:#EDE9DF;
  --border:rgba(20,18,14,0.10); --border-bright:rgba(20,18,14,0.22);
  /* Brand reds stay; soften apt-rose for light backgrounds */
  --apt-red:#D6172E; --apt-red-deep:#A10921; --apt-rose:#C84453; --apt-amber:#C77A18;
  --text-1:#1A1410; --text-2:#2F2A23; --text-3:#5C5446; --text-4:#857B6A; --text-5:#B4AB99;
  --surface-1:rgba(255,255,255,0.78); --surface-2:rgba(255,255,255,0.92); --surface-3:rgba(244,241,234,0.96);
...
.stk-head { display:grid; grid-template-columns:80px 1fr 180px 95px 75px 60px 70px 70px; gap:12px; padding:14px 22px; border-bottom:1px solid var(--border); background:var(--surface-3); backdrop-filter:blur(16px); -webkit-backdrop-filter:blur(16px); font-family:'DM Mono',monospace; font-size:10px; letter-spacing:1.5px; color:var(--text-3); text-transform:uppercase; position:sticky; top:0; z-index:3; }
...
body.page-stocks .lib.lib-wide { height:calc(100vh - 90px); padding-top:18px; padding-bottom:14px; display:flex; flex-direction:column; min-height:0; }
body.page-stocks .lib.lib-wide .lib-h { flex-shrink:0; }
body.page-stocks .stk-toprow { position:static; flex-shrink:0; margin-bottom:10px; }
body.page-stocks .stk-wrap { flex:1 1 auto; min-height:0; margin-top:0; align-items:stretch; }
body.page-stocks .stk-sidebar { position:static; top:auto; max-height:none; height:100%; }
body.page-stocks .stk-main { display:flex; flex-direction:column; min-height:0; height:100%; }
body.page-stocks .stk-table { flex:1 1 auto; min-height:0; max-height:none; }
body.page-stocks .picks-meta { display:none; }
body.page-stocks .footer { display:none; }
...
.fp-meta-src { font-family:'DM Mono',monospace; font-size:10px; color:var(--text-3); white-space:nowrap; }
...
.fp-meta-asof { font-family:'DM Mono',monospace; font-size:10px; color:var(--text-3); white-space:nowrap; }
...
(function(){
  ...
  if (btn) {
    btn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('apt-theme', next); } catch(e) {}
      syncIcon();
...
(function(){{
  try {{
    var t = localStorage.getItem('apt-theme');
