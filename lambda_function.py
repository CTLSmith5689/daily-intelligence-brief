...
.stk-filter-row { display:grid; grid-template-columns:160px 110px auto 110px 1fr; align-items:center; gap:10px; }
  ...
  <div class="lib-controls">
    ...
    <div class="stk-filter-panel" id="stk-filter-panel" hidden>
      ...
      <div class="stk-filter-row">
        ...
        <span class="stk-filter-hint">absolute multiple, blank for no limit</span>
      </div>
      <div class="stk-filter-row">
        ...
        <span class="stk-filter-hint">enter as percent</span>
      </div>
      <div class="stk-filter-row">
        ...
        <span class="stk-filter-hint">always &le; 0; -30 means 30% off the high</span>
      </div>
      <div class="stk-filter-row">
      ...
      <div class="stk-filter-row">
        ...
        <span class="stk-filter-hint">ratio; negative means net cash</span>
      </div>
