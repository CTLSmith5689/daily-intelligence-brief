...
.stk-score { font-family:'Space Mono',monospace; font-size:13px; font-weight:600; text-align:right; padding-top:1px; letter-spacing:0.02em; }
...
(function(){{
  try {{
    ...
    // Light is the default: the screener design is a light design. An explicit
    // stored choice still wins in both directions.
